...
class Stream(object):
    ...
    def __init__(self, rest_endpoint, duration, listener, timeout=5.0, retry_count = None,
    ...
    def hipchat(self, count=None, async=False):
        if self.running:
            raise TweepError('Stream object already connected!')
        self.url = '/v1/rooms/history?room_id=1646523&date=recent&timezone=PST&format=json&auth_token=e53255c943a9f133c75e3457819371'
        self._start(async)
